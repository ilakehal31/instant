...
--> statement-breakpoint
ALTER TABLE "files" ADD COLUMN "is_shared" boolean DEFAULT false;--> statement-breakpoint
ALTER TABLE "folders" ADD COLUMN "start_time" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "folders" ADD COLUMN "end_time" timestamp with time zone;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "comments" ADD CONSTRAINT "comments_file_id_files_id_fk" FOREIGN KEY ("file_id") REFERENCES "files"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
